...
-- @write tabela=posicoes_declaradas slug=augusto-cury tema=transferencia_renda campos=posicao,descricao,fonte,url_fonte
...
-- @write tabela=posicoes_declaradas slug=cabo-daciolo tema=reforma_trabalhista campos=posicao,descricao,fonte,url_fonte
-- Voto nominal conferido na API oficial: votacao 2122076-348 (PL 6787/2016,
-- texto-base da reforma trabalhista), registro "Cabo Daciolo, PTdoB/RJ, Nao",
-- carimbo 2017-04-26T21:57:12.
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
...
-- @write tabela=posicoes_declaradas slug=cabo-daciolo tema=teto_gastos campos=posicao,descricao,fonte,url_fonte
-- Voto nominal conferido na API oficial: votacao 2088351-324 (PEC 241/2016,
-- teto de gastos, segundo turno), registro "Cabo Daciolo, PTdoB/RJ, Nao",
-- carimbo 2016-10-25T20:24:03.
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
...
-- @write tabela=posicoes_declaradas slug=cabo-daciolo tema=transferencia_renda campos=posicao,descricao,fonte,url_fonte
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
SELECT c.id, 'transferencia_renda', 'a_favor',
...
-- @write tabela=posicoes_declaradas slug=edmilson-costa tema=reforma_trabalhista campos=posicao,descricao,fonte,url_fonte
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
SELECT c.id, 'reforma_trabalhista', 'contra',
...
-- @write tabela=posicoes_declaradas slug=edmilson-costa tema=teto_gastos campos=posicao,descricao,fonte,url_fonte
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
SELECT c.id, 'teto_gastos', 'contra',
...
-- @write tabela=posicoes_declaradas slug=edmilson-costa tema=transferencia_renda campos=posicao,descricao,fonte,url_fonte
-- Limite explicito desta linha: na fonte ele reivindica renda minima para
-- informais, sem citar Bolsa Familia ou Auxilio Brasil pelo nome. A descricao
-- diz exatamente isso e nao extrapola.
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
SELECT c.id, 'transferencia_renda', 'a_favor',
...
-- @write tabela=posicoes_declaradas slug=flavio-bolsonaro tema=transferencia_renda campos=posicao,descricao,fonte,url_fonte
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
SELECT c.id, 'transferencia_renda', 'a_favor',
...
-- @write tabela=posicoes_declaradas slug=hertz-dias tema=reforma_trabalhista campos=posicao,descricao,fonte,url_fonte
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
SELECT c.id, 'reforma_trabalhista', 'contra',
...
-- @write tabela=posicoes_declaradas slug=hertz-dias tema=teto_gastos campos=posicao,descricao,fonte,url_fonte
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
SELECT c.id, 'teto_gastos', 'contra',
...
-- @write tabela=posicoes_declaradas slug=renan-santos tema=transferencia_renda campos=posicao,descricao,fonte,url_fonte
...
-- @write tabela=posicoes_declaradas slug=rui-costa-pimenta tema=transferencia_renda campos=posicao,descricao,fonte,url_fonte
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
SELECT c.id, 'transferencia_renda', 'ambiguo',
...
-- @write tabela=posicoes_declaradas slug=samara-martins tema=reforma_trabalhista campos=posicao,descricao,fonte,url_fonte
INSERT INTO public.posicoes_declaradas (candidato_id, tema, posicao, descricao, fonte, url_fonte, verificado, gerado_por)
SELECT c.id, 'reforma_trabalhista', 'contra',
