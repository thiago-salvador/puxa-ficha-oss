...
-- @write tabela=pontos_atencao ref=familia-sem-mandato-eletivo campos=despublicacao_motivo,despublicado_em
...
-- @write tabela=pontos_atencao slug=alvaro-dias-rn campos=fontes
-- A URL do MPRN nao responde para acesso automatizado. O fato foi confirmado
-- em fonte viva, lida em 2026-08-03: "A Justica Eleitoral reconheceu o
-- ex-prefeito de Natal, Alvaro Dias (Republicanos), como reu na acao de
-- investigacao judicial eleitoral (AIJE) movida pelo Ministerio Publico do Rio
-- Grande do Norte (MPRN) e manteve as provas apresentadas pelas promotorias
-- eleitorais." A fonte original fica registrada em segundo lugar, porque e a
-- primaria e pode voltar.
