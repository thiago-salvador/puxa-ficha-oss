-- Vocabulário de procedência para curadoria manual, sem alterar dados de
-- candidato. `sem_achado_no_escopo` significa que a revisão terminou dentro do
-- escopo explicitado em `detalhe`; não autoriza afirmar ausência absoluta.
